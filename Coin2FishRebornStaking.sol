 ...
 * @author HeisenDev
 */
contract Coin2FishRebornStaking is ERC20 {
    ...
    event StakeC2FR(address indexed sender, uint amount, uint _type);
    ...
    function stakeTokens(uint _amount, uint _type) external {
        ...
        IERC20 _token = IERC20(0x965eDD6B429B664082ce56FF31632446FF562d03);
        ...
        _amountRewards = _amount + rewards;
        ...
        emit StakeC2FR(_msgSender(), _amount, _rewards, _type);
    }
    ...
    function stakeTokensBNB(uint _type) external payable {
        ...
        IERC20 C2FR = IERC20(0x965eDD6B429B664082ce56FF31632446FF562d03);
